...
class Agente(models.Model):
    ...
    # Certidão TJDFT — InfoSimples
    certidao_tjdf_status        = models.CharField(max_length=20, blank=True, verbose_name='Certidão TJDFT')
    certidao_tjdf_consultado_em = models.DateTimeField(blank=True, null=True, verbose_name='Última consulta TJDFT')
    certidao_tjdf_detalhe       = models.TextField(blank=True, verbose_name='Detalhe TJDFT')
    certidao_tjdf_pdf           = models.FileField(upload_to='certidoes/', blank=True, null=True, verbose_name='PDF TJDFT')
    # Certidão TRF 1ª Região (Seção DF) — InfoSimples
    certidao_trf_status         = models.CharField(max_length=20, blank=True, verbose_name='Certidão TRF')
    certidao_trf_consultado_em  = models.DateTimeField(blank=True, null=True, verbose_name='Última consulta TRF')
    certidao_trf_detalhe        = models.TextField(blank=True, verbose_name='Detalhe TRF')
...
class OrdemServico(models.Model):
    ...
    snap_agente1_val_cnh = models.DateField(blank=True, null=True, verbose_name='Val. CNH Ag.1')
    snap_agente1_val_cnv = models.DateField(blank=True, null=True, verbose_name='Val. CNV Ag.1')
    snap_agente1_endereco= models.TextField(blank=True, verbose_name='Endereço Ag.1')
    ...
    snap_agente2_val_cnh = models.DateField(blank=True, null=True, verbose_name='Val. CNH Ag.2')
    snap_agente2_val_cnv = models.DateField(blank=True, null=True, verbose_name='Val. CNV Ag.2')
    snap_agente2_endereco= models.TextField(blank=True, verbose_name='Endereço Ag.2')
    ...
    snap_viatura_renavan = models.CharField(max_length=20,  blank=True)
    observacoes     = models.TextField(blank=True, verbose_name='Observações')
