...
urlpatterns = [
    ...
    path('agentes/<int:pk>/inativar/', views.agente_toggle_ativo, name='agente_toggle_ativo'),
    path('agentes/<int:pk>/certidao-tjdf/', views.agente_certidao_tjdf, name='agente_certidao_tjdf'),
    path('agentes/<int:pk>/certidao-trf/',  views.agente_certidao_trf,  name='agente_certidao_trf'),
...
# OS - Link externo do agente (field)
urlpatterns += [
...
urlpatterns += [
    ...
    path('patrimonial/jrs-facilities/<int:pk>/reconsultar/', views.consulta_processo_reconsultar, name='jrsfacilities_reconsultar'),
